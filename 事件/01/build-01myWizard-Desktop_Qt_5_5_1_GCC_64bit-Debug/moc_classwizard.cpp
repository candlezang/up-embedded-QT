...
#include "../01myWizard/classwizard.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_classWizard_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_classWizard_t qt_meta_stringdata_classWizard = {
    {
QT_MOC_LITERAL(0, 0, 11) // "classWizard"
...
const QMetaObject classWizard::staticMetaObject = {
    { &QWizard::staticMetaObject, qt_meta_stringdata_classWizard.data,
      qt_meta_data_classWizard,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *classWizard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_classWizard.stringdata0))
